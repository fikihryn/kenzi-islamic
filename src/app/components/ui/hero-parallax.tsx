...
export const Header = () => {
  ...
  Preview <br /> Produk Terbaik Kami
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-black">
      Kami memproduksi mukena yang fungsional dan elegan dengan menggunakan bahan berkualitas tinggi.
      Setiap produk dibuat dengan cermat untuk memberikan kenyamanan dan keindahan saat beribadah.
      </p>
    </div>
  );
};
